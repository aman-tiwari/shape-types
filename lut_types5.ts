...
export type Number = [LUTIndex,LUTIndex,LUTIndex,LUTIndex,LUTIndex];
...
export type Add5_<X extends Number, Y extends Number> = 
    [AddLUT[X[0]][Y[0]],AddLUT[X[1]][Y[1]],AddLUT[X[2]][Y[2]],AddLUT[X[3]][Y[3]],AddLUT[X[4]][Y[4]]];

export type Add5<X extends Number, Y extends Number> = 
    Unwrap5<PropCarry5<Add5_<X, Y>>>
;

export type PropCarry5Iter<X extends LUTValue[]> =
    [AddLUT[X[1]['c']][X[0]['v']],AddLUT[X[2]['c']][X[1]['v']],AddLUT[X[3]['c']][X[2]['v']],AddLUT[X[4]['c']][X[3]['v']],{v: X[3]['v'], c: 0}];

export type PropCarry5<X extends LUTValue[]> =
    PropCarry5Iter<PropCarry5Iter<PropCarry5Iter<PropCarry5Iter<PropCarry5Iter<X>>>>>;

export type Sub5_ <X extends Number, Y extends Number> = 
[SubLUT[X[0]][Y[0]],SubLUT[X[1]][Y[1]],SubLUT[X[2]][Y[2]],SubLUT[X[3]][Y[3]],SubLUT[X[4]][Y[4]]]
;

export type Sub5<X extends Number, Y extends Number> = 
    Unwrap5<PropBorrow5<Sub5_<X, Y>>>;

export type PropBorrow5Iter<X extends LUTValue[]> =
    [SubLUT[X[0]['v']][X[1]['c']],SubLUT[X[1]['v']][X[2]['c']],SubLUT[X[2]['v']][X[3]['c']],SubLUT[X[3]['v']][X[4]['c']],{v: X[3]['v'], c: 0}];

export type PropBorrow5<X extends LUTValue[]> =
    PropBorrow5Iter<PropBorrow5Iter<PropBorrow5Iter<PropBorrow5Iter<PropBorrow5Iter<X>>>>>;

export type Unwrap5<X extends LUTValue[]> =
    [X[0]['v'],X[1]['v'],X[2]['v'],X[3]['v'],X[4]['v']];
